...
from .views import AlertListView, AlertDetailView, AlertAcknowledgeView, RunAnomalyCheckView
...
urlpatterns = [
    ...
    path("run-check/",               RunAnomalyCheckView.as_view(), name="alert-run-check"),
]
